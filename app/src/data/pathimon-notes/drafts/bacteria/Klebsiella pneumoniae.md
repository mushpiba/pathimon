...
대처법:
직접: 세프트리악손, 피페라실린-타조박탐, 카바페넴
증상/태그: 세균, 그람음성, 세포외, 협막, 호흡기, 요로, 혈류, 폐렴, 기침, 호흡 곤란, 발열
이미지:
...
- 준비기 후보: 점액 협막 팽창
- 공격기 후보: 폐포 점액 장악, 내독소 발열
- 전용기 후보: 점액 협막 성벽
- 상태이상 배치: 공격기 상태이상 존재: 폐포 점액 장악: 기침; 내독소 발열: 발열. 실제 독소/침습/조직손상 결과면 유지하고, 감염경로/정착성 결과면 준비기로 이동 검토.
