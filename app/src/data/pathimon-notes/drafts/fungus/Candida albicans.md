...
- 준비기 후보: 점막 정착
- 공격기 후보: 균사 침투, 바이오필름 막
- 전용기 후보: 효모-균사 전환
- 상태이상 배치: 공격기 상태이상 존재: 균사 침투: 부종; 바이오필름 막: 면역 이상(2). 실제 독소/침습/조직손상 결과면 유지하고, 감염경로/정착성 결과면 준비기로 이동 검토.
- 방어특성 검토: `형태전환`: 병원체의 회피/생존 구조로 적절한지, 보스 공격 타입(인체 방어/치료 행위)과 직관적으로 맞물리는지 재검토.
